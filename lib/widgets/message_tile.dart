    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: widget.sendByMe ? Colors.deepPurple.withOpacity(.5) : Colors.grey[700]
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(widget.sender.toUpperCase(),textAlign: TextAlign.center,style: const TextStyle(fontSize: 13,fontWeight: FontWeight.bold),),
